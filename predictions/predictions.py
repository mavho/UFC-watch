...
class Predictions():
    ...
    def predict(self, bout_listing_name=None, red_fighter=None,blue_fighter=None) -> Dict[str,Any]:
        """
        ...
        if bout_listing_name != None:
            out_fighters = predict_from_boutListing(bout_listing_name,fight_list)
