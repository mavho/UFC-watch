...
class Predictions():
    ...
    def train_weight_class(self,weight_dataframe):
    ...
    def predict(self):
        ...
        for(blue_fighter, red_fighter) in fight_list:
            ...
            data.append(self.populate_dataframes(fighter_frame, blue_fighter,red_fighter, connection))
        ...
        self.populate_dataframes(weight_frame, '','', connection)
    #    print(weight_frame)
