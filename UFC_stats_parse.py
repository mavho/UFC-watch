...
class UFC_Stats_Parser():
    ...
    def __init__(self,plistfile,url='http://http://www.ufcstats.com/statistics/events/completed?page=all'):
        """
        ...
        self._generate_proxy_list(self.proxy_list,self.plistfile)
        self.url = url
    
    def _generate_proxy_list(self, proxy_list, plist):
        fobj = open(plist, "r")
    ...
    def _parse_listing(self, data, fight_stats):
        ...
        data_bytes = self.get_raw_HTML(fight_details_url)
...
def main():
    ...
    data_bytes = parser.get_raw_HTML()
